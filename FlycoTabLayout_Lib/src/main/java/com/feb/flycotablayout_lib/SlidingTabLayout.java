package com.feb.flycotablayout_lib;
...
import com.feb.flycotablayout_lib.listener.OnTabSelectListener;
import com.feb.flycotablayout_lib.utils.UnreadMsgUtils;
import com.feb.flycotablayout_lib.widget.MsgView;
...
public class SlidingTabLayout  extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private static final int STYLE_SHADOW = 4;
    ...
    private Drawable mCustomIndicator;
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mABoolean = ta.getBoolean(R.styleable.SlidingTabLayout_tl_use_shadow, false);
        ...
        mCustomIndicator = ta.getDrawable(R.styleable.SlidingTabLayout_tl_indicator_drawable);
        mDrawable = (BitmapDrawable) ta.getDrawable(R.styleable.SlidingTabLayout_tl_tab_select_bg_res);
        ta.recycle();
    }
    ...
    private void addTab(final int position, String title, View tabView) {
        ...
        if (tv_tab_title != null) {
            ...
            mTextWidth = tv_tab_title.getMeasuredWidth();
        }
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
            ...
            if (tab_title != null) {
                ...
                if (mTextBold == TEXT_BOLD_WHEN_SELECT) {
                    if (isSelect) {
                        ...
                        mTextWidth = tab_title.getMeasuredWidth() == 0 ? tab_title.getPaint().measureText(tab_title.getText().toString()) + tab_title.getPaddingLeft() : tab_title.getMeasuredWidth();
                    } else {
                        tab_title.setTypeface(Typeface.DEFAULT);
                    }
                }
                if (mIndicatorStyle == STYLE_SHADOW || mABoolean) {
                    if (isSelect) {
                        tab_title.setShadowLayer(dp2px(1f), -dp2px(2f), -dp2px(2f), Color.parseColor("#FFB12742"));
                    } else {
                        tab_title.setShadowLayer(0f, 0f, 0f, Color.TRANSPARENT);
                    }
                }
            }
        }
    ...
    private void calcIndicatorRect() {
        ...
        if (mIndicatorStyle == STYLE_NORMAL && mIndicatorWidthEqualTitle) {
            ...
            mTextWidth = tab_title.getMeasuredWidth();
        ...
        if (this.mCurrentTab < mTabCount - 1) {
            ...
            if (mIndicatorStyle == STYLE_NORMAL && mIndicatorWidthEqualTitle) {
                ...
                mTextWidth = next_tab_title.getMeasuredWidth();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIndicatorStyle == STYLE_TRIANGLE) {
            ...
            if (mIndicatorHeight > 0) {
                ...
                if (mDrawable == null) mDrawable = new BitmapDrawable();
                mDrawable.setAntiAlias(true);
                mDrawable.setBounds(paddingLeft + (int) mIndicatorMarginLeft + mIndicatorRect.left,
            ...
            if (mIndicatorGravity == Gravity.BOTTOM) {
                mCustomIndicator.setBounds(paddingLeft + (int) mIndicatorMarginLeft + mIndicatorRect.left,
                        height - (int) mIndicatorHeight - (int) mIndicatorMarginBottom,
                        paddingLeft + mIndicatorRect.right - (int) mIndicatorMarginRight,
                        height - (int) mIndicatorMarginBottom);
            } else {
            ...
            if (mIndicatorHeight > 0) {
                ...
                if (mIndicatorGravity == Gravity.BOTTOM) {
                    mIndicatorDrawable.setBounds(paddingLeft + (int) mIndicatorMarginLeft + mIndicatorRect.left,
                            ...
                            paddingLeft + mIndicatorRect.right - (int) mIndicatorMarginRight,
                            height - (int) mIndicatorMarginBottom);
                } else if (mIndicatorGravity == Gravity.START && mTextWidth > mIndicatorWidth) {
                    mIndicatorDrawable.setBounds(paddingLeft + (int) mIndicatorMarginLeft + mIndicatorRect.left - (int) (mTextWidth - mIndicatorWidth) / 2,
                            (int) mIndicatorMarginTop,
                            paddingLeft + mIndicatorRect.right - (int) mIndicatorMarginRight - (int) (mTextWidth - mIndicatorWidth) / 2 + (int) mIndicatorMarginLeft,
                            (int) mIndicatorHeight + (int) mIndicatorMarginTop);
                } else {
                    mIndicatorDrawable.setBounds(paddingLeft + (int) mIndicatorMarginLeft + mIndicatorRect.left,
                            (int) mIndicatorMarginTop,
    ...
    public void setIndicatorDrawable(int indicatorDrawable) {
        this.mCustomIndicator = ContextCompat.getDrawable(mContext, indicatorDrawable);
        invalidate();
    }
    ...
    public void showDotNew(int position, boolean isShow) {
        if (position >= mTabCount) {
            position = mTabCount - 1;
        }

        View tabView = mTabsContainer.getChildAt(position);
        ImageView tipView = tabView.findViewById(R.id.iv_red_point);
        if (tipView != null) {
            tipView.setVisibility(isShow ? VISIBLE : INVISIBLE);
            startShakeByPropertyAnim(tipView, 0.9f, 1.1f, 10f, 1000);
        }
    }
